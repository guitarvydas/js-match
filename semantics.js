...
semantics.addOperation(
	...
	Rule: function (head, _eq, body) { return head.transpile () + " " + body.transpile ();},
	Fact: function (head) { return head.transpile (); },
	Query: function (_match, _lpar, expression, _rpar) { return expression.transpile ();},
	...
	logicVariable: function (uc, cs) { return uc.transpile () + cs.transpile ().join(''); },
